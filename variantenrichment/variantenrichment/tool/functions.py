...
CASE_FILES = ["../data/example/HG00102_ex.vcf.gz", "../data/example/HG00107_ex.vcf.gz"]
GENE_FILE = "../data/example/genes.bed"
INHERITANCE_FILE = "../data/example/inheritance.txt"
IMPACT = "HIGH"
IMPACT_MOD = "MODERATE"
GENES_MOD = ["JUP", "OXTR"]
FREQUENCY = 0.9

CONTROL_FILE = "../data/IGSR.vcf.gz"
DB_FILE = "../data/hg19_refseq_curated.ser"
